...
public class SurvivorAI : MonoBehaviour
{
    ...
    void GrenadeThrown()
    {
        GameObject i = Instantiate(grenadePrefab, new Vector3(survivor.transform.position.x, survivor.transform.position.y + 2.7f, survivor.transform.position.z), Random.rotation);
